...
$.fn.gMapsLatLonPicker = (function() {
	...
	_self.params = {
		...
		strings : {
			...
			error_empty_field : "Search data is empty",
	...
	var displayError = function(message) {
	    ...
	    //End Custom notification plugin
	...
	var publicfunc = {
		...
		init : function(object) {
			...
			if(!$("#gllpLatitude").val() || !$("#gllpLongitude").val()){
				_self.vars.marker.setVisible(false); // maps API hide call
			}else{
				_self.vars.marker.setVisible(true); // maps API show call
			}
			
			/*	
			if($("#gllpLatitude").prop('disabled') || $("#gllpLongitude").prop('disabled')){	
				_self.vars.marker.setOptions({draggable: false});
			}else{
				_self.vars.marker.setOptions({draggable: true});
			}
			*/
				
			// Set position on doubleclick
			google.maps.event.addListener(_self.vars.map, 'click', function(event) {
				if(!_self.vars.marker.getVisible()){
